          ...
          <Container maxWidth="md" sx={{ py: 8 }}>
               <Paper elevation={3} sx={{ p: 4, borderRadius: 2, textAlign: "center" }}>
                    ...
                    <Typography variant="body1" sx={{ mb: 4 }}>
                         It looks like there was an error starting your free trial. You can try again, or contact our support team at support@housecouncil.com if you need help.
                    </Typography>
                    ...
                    <Typography variant="body2" color="text.secondary">
                         If you have any questions or need help, contact our support team at support@housecouncil.com
                    </Typography>
               </Paper>
          </Container>
     )
