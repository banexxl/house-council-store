...
export async function checkUserPermissionServer(email: string): Promise<{ success: boolean; error?: ErrorType }> {
     ...
     try {
          ...
          console.log('[checkUserPermissionServer] tblTenants query result:', { tenantError: tenantError?.message, foundTenant: !!tenantData?.email });
          ...
          console.log('[checkUserPermissionServer] tblPolarCustomers query result:', { customerError: customerError?.message, foundCustomer: !!customerData?.email });
