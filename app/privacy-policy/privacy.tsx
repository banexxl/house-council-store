                              ...
                              <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: 4 }}>
                                   ...
                                   >
                                        <section id="introduction">
                                             ...
                                             <Typography color="text.secondary" sx={{ fontWeight: 400, fontSize: { xs: "1rem", sm: "1.1rem" } }}>
                                        ...
                                        <section id="information-collection">
                                             ...
                                             <Typography component="h2" gutterBottom color="primary" sx={{ fontWeight: 700, fontSize: { xs: "1rem", sm: "1.2rem" }, mt: 2 }}>
                                        ...
                                        <section id="your-rights">
                                             ...
                                             <Typography color="text.secondary" sx={{ fontWeight: 400, fontSize: { xs: "1rem", sm: "1.1rem" }, mt: 2 }}>
